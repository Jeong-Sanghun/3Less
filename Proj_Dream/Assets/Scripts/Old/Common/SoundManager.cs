...
{
    public AudioSource[] audioArrayBGM;

    // Start is called before the first frame update
    void Start()
    {
        audioArrayBGM[0].Play();
    ...
    "쏟아질 듯 하늘을 가득 채운 별, TV에서나 보던 너른 들판과 세상을 집어삼킬 듯 새카만 호수.",
    "너무 생소한 광경에 무서울 지경이다.",
    ...
    "악!",
    "뭔 금붕어가 이렇게 커? 떠 다녀? 이게 뭔데!",
    "금붕어는 허공에 고요하게 떠 있다. 바람 한 점 불지 않는데 지느러미가 하늘하늘 나부낀다.",
    "살아 있는 건가...?",
    "둥그렇게 뜬 눈을 빤히 바라보지만 미동도 없다.",
    "모형치고는 보석처럼 잘 세공된 비늘과 나비 날개 같은 지느러미가 너무 정교하다.",
    "내 꿈에 온 걸 환영해.",
