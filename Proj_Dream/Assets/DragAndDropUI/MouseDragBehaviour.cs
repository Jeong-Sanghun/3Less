...
public class MouseDragBehaviour : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    public bool isUseDrage = false;

    public Image imgCutter1;
    public Image imgCutter2;
    ...
    void Start()
    {
       // goCutterAnim.SetActive(false);
        defaultPos = new Vector2(gameObject.transform.position.x, gameObject.transform.position.y);
    }
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        if(isUseDrage)
        {
            ...
            //    isFirstDrag = true;
                ...
                imgCutter1.enabled = false;
                imgCutter2.enabled = true;
            //}
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        if (isUseDrage)
        {
            ...
            imgCutter1.enabled = true;
            imgCutter2.enabled = false;
